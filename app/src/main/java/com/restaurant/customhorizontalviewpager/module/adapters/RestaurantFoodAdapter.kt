...
class RestaurantFoodAdapter(
    ...
    private val onItemClickListener: (position: Int) -> Unit) : RecyclerView.Adapter<RestaurantFoodAdapter.ViewHolder>() {
    class ViewHolder(val view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val context = parent.context
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.layout_restaurant_food, parent, false)
